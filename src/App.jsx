...
import { Phone, Mail, Instagram, Facebook, Youtube, Menu, X, ArrowRight, MessageCircle, Calendar, Users, Award } from 'lucide-react'
...
const flyerContent = {
  ...
  goal: "Menciptakan generasi muslim yang berpegang teguh pada Al-Quran dan As-Sunnah di atas manhaj As-Salafush Sholih sehingga mampu menjawab tantangan fitnah syubhat dan syahwat.",
  registration: [
        ...
        {isGalleryModalOpen && (
          ...
          >
            ...
            >
              ...
              <div className="flex justify-center border-t border-slate-50 pt-10">
                <button 
                  onClick={() => setIsGalleryModalOpen(false)}
                  className="bg-primary text-white px-10 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-secondary transition-all shadow-xl shadow-primary/20"
                >
                  Kembali ke Beranda
                </button>
              </div>
